...
public class QAttachImage extends EntityPathBase<AttachImage> {
    ...
    public final ListPath<com.cglee079.pododev.web.domain.blog.attachimage.save.AttachImageSaveEntity, com.cglee079.pododev.web.domain.blog.attachimage.save.QAttachImageSaveEntity> saves = this.<com.cglee079.pododev.web.domain.blog.attachimage.save.AttachImageSaveEntity, com.cglee079.pododev.web.domain.blog.attachimage.save.QAttachImageSaveEntity>createList("saves", com.cglee079.pododev.web.domain.blog.attachimage.save.AttachImageSaveEntity.class, com.cglee079.pododev.web.domain.blog.attachimage.save.QAttachImageSaveEntity.class, PathInits.DIRECT2);
