...
import com.podo.pododev.backend.global.external.solr.dto.BlogSearchResult;
import com.podo.pododev.backend.global.external.solr.dto.SolrResponse;
import com.podo.pododev.backend.global.external.solr.exception.SearchApiException;
import com.podo.pododev.backend.global.external.solr.exception.SearchWordApiException;
...
public class SolrSearchService {
    ...
    @Value("${external.solr.highlight.pre_max_text_length:}")
    private Integer maxTextLengthBeforeHighlight;

    @Value("${external.solr.highlight.frag.length:}")
