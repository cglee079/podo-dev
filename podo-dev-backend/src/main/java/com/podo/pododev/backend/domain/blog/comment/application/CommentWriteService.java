...
import com.podo.pododev.backend.domain.blog.comment.application.helper.CommentServiceHelper;
import com.podo.pododev.backend.domain.blog.comment.dto.CommentInsert;
import com.podo.pododev.backend.domain.blog.comment.exception.MaxDepthCommentApiException;
...
import com.podo.pododev.backend.domain.user.application.helper.UserServiceHelper;
...
import com.podo.pododev.backend.global.cache.annotation.AllCommentCacheEvict;
import com.podo.pododev.backend.global.context.ThreadLocalContext;
import com.podo.pododev.backend.global.event.ReplyCommentNotifyDto;
import com.podo.pododev.backend.global.event.ReplyCommentNotifyPublisher;
import com.podo.pododev.backend.global.event.UserCommentNotifyDto;
import com.podo.pododev.backend.global.event.UserCommentNotifyPublisher;
...
public class CommentWriteService {
    ...
    @Value("${blog.comment.max.depth:10}")
