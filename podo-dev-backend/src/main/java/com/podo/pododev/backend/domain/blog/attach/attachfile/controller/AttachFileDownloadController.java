package com.podo.pododev.backend.domain.blog.attach.attachfile.controller;

import com.podo.pododev.core.util.PathUtil;
import com.podo.pododev.core.util.type.RequestHeader;
import com.podo.pododev.backend.domain.blog.attach.attachfile.application.AttachReadService;
import com.podo.pododev.backend.domain.blog.attach.attachfile.dto.AttachFileDownload;
import com.podo.pododev.backend.global.util.HttpRequestUtil;
import com.podo.pododev.backend.global.util.HttpResponseUtil;
...
public class AttachFileDownloadController {
    ...
    @Value("${external.storage.static.internal:}")
