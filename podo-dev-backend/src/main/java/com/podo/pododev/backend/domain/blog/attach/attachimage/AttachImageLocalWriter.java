package com.podo.pododev.backend.domain.blog.attach.attachimage;

import com.podo.pododev.core.util.PathUtil;
import com.podo.pododev.backend.domain.blog.attach.attachimage.exception.InvalidImageFileApiException;
import com.podo.pododev.backend.domain.blog.attach.attachimage.exception.InvalidImageUrlApiException;
import com.podo.pododev.backend.domain.blog.attach.attachimage.model.AttachImageSave;
import com.podo.pododev.backend.domain.blog.attach.attachimage.value.ImageSizeVo;
import com.podo.pododev.backend.global.util.FilenameCreator;
import com.podo.pododev.backend.global.util.ImageValidator;
...
public class AttachImageLocalWriter {
    ...
    public Map<String, AttachImageSave> writeImageToMultipleSizeFromImageUrl(String imageUrl) {
        ...
        final String localSavedLocation = PathUtil.merge(localAttachImageDirectory, FilenameCreator.createPathByDate(LocalDateTime.now())); // 로컬 저장경로
...
//        log.debug("Resize Image, size : '{}', from : '{}'", resizeWidth, originImage.getName());
//
